...
- **投稿画面**
  ...
  - タグをつけてダメ人間エピソード投稿
- **TDN画面**
  - 今日のTDN(Today Dame Ningen)を表示
  - 過去のTDNを表示
- **ユーザ一覧画面**
  - 全ユーザ一覧表示
    - タップするとユーザー名、ランク、フォロー、アクティビティ、
    - 総いいね数フォロワー、フォロー中ｍ投稿エピソードが閲覧可能 
- **プロフィール画面**
  - 基本情報(ユーザー名、メールアドレス、自己紹介、誕生日)表示
  - フォロー情報表示
  - アクティビティカレンダー(GitHub風)
     - 投稿数＋いいねの数の合計で色が変化する。　 
---
